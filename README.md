...
Яндекс.Деньги, PayPal - Преобритал чтоббы поддержать разработчиков и по этой пречине тек же не выкладываю.<br><br>
Модифицированный файл plugins.php включенны в список не официальные плагины для DLE-Billing v0.6<br><br>
